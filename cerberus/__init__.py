...
# 0.7.0: web dashboard rebuilt (Architectural Glassmorphism UI) with a live
#        isometric enclave cube, real run history ("Timeline & History"), a
#        live-from-policy.py architecture view, and a real manual-kill
#        control -- every figure on the page is produced by an actual run,
#        nothing mocked.
