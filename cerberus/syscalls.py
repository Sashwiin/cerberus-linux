"""x86_64 syscall number table (the subset Cerberus reasons about).

Kept as a literal table rather than parsed from <asm/unistd_64.h> so the
supervisor has no build-time dependency on kernel headers.
"""
...
X86_64 = {
    ...
    "readlink": 89, "chmod": 90, "fchmod": 91, "chown": 92,
    ...
    "sigaltstack": 131, "mknod": 133, "personality": 135,
    "statfs": 137, "fstatfs": 138, "sched_setscheduler": 144,
    ...
    "timer_create": 222, "timer_settime": 223, "clock_settime": 227,
    ...
    "get_mempolicy": 239, "add_key": 248, "request_key": 249,
    "keyctl": 250, "ioprio_set": 251, "inotify_init": 253,
    "inotify_add_watch": 254, "migrate_pages": 256, "openat": 257,
    "mkdirat": 258, "mknodat": 259, "fchownat": 260, "newfstatat": 262,
    ...
    "timerfd_settime": 286, "accept4": 288, "signalfd4": 289,
    ...
    "kcmp": 312, "finit_module": 313, "sched_setattr": 314,
    "sched_getattr": 315, "renameat2": 316, "seccomp": 317,
    "getrandom": 318, "memfd_create": 319, "kexec_file_load": 320,
    "bpf": 321, "execveat": 322, "userfaultfd": 323, "membarrier": 324,
    ...
    "map_shadow_stack": 453, "futex_wake": 454, "futex_wait": 455,
    "futex_requeue": 456, "statmount": 457, "listmount": 458,
    "lsm_get_self_attr": 459, "lsm_set_self_attr": 460,
    "lsm_list_modules": 461, "mseal": 462,
}

NR_TO_NAME = {v: k for k, v in X86_64.items()}


def name(nr: int) -> str:
    return NR_TO_NAME.get(nr, f"syscall_{nr}")


def nr(sysname: str) -> int:
    return X86_64[sysname]
